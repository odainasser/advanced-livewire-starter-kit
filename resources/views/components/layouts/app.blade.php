<x-layouts.app.sidebar>
    <flux:main class="flex flex-col min-h-screen">
        ...
        @if (session('error'))
            ...
            class="fixed inset-x-0 top-0 z-50"
            >
            <div class="bg-red-500 shadow-lg dark:bg-red-700">
                <div class="mx-auto max-w-7xl px-4 py-3 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between gap-4">
                    <div class="flex items-center gap-x-3">
                    <div class="flex-shrink-0">
                    ...
                    @click="show = false"
                    type="button"
                    class="rounded-md p-1.5 text-white hover:bg-red-600 hover:text-white focus:outline-none focus:ring-2 focus:ring-red-600 focus:ring-offset-2 dark:text-white dark:hover:bg-red-800 dark:hover:text-white"
                    >
                    <span class="sr-only">Dismiss</span>
                    <svg class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                        <path d="M6.28 5.22a.75.75 0 00-1.06 1.06L8.94 10l-3.72 3.72a.75.75 0 101.06 1.06L10 11.06l3.72 3.72a.75.75 0 101.06-1.06L11.06 10l3.72-3.72a.75.75 0 00-1.06-1.06L10 8.94 6.28 5.22z" />
